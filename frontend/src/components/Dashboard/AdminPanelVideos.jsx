      ...
      <div className="flex items-start">
        <div className="relative w-full max-w-lg  overflow-hidden">
          <input
            ...
            className="w-full peer rounded-r-[20px] border focus:border-[#e81cff] bg-transparent py-1 pl-9 pr-3 placeholder-white outline-none sm:py-2"
            placeholder="Search"
          />
          <span className="absolute peer-focus:text-[#e81cff] left-2.5 top-1/2 inline-block -translate-y-1/2">
            <svg
